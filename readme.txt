...
This plugin Extends the plugin WP Security Audit Log to log events from the Paid Memberships Pro plugin.
This also includes some audit logs to track changes to User Meta values.
